            ...
            <div class="col-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col">
                                <form role="form" action="<?php echo base_url('person/create')?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="region_id" id="region">
											    ...
											    <?php foreach ($region as $rows_region): ?>
												    <option value="<?php echo $rows_region->id?>"><?php echo $rows_region->name; ?></option>
											    <?php endforeach; ?>
										</select>
									</div>
                                    <div class="form-group">
										<label>Alamat *</label>
										<textarea name="address" class="form-control" rows="6" placeholder="Masukan Alamat Lengkap" required=""></textarea>
                                    </div>
                                    <div class="form-group">
										<label>Income *</label>
										<input type="number" name="income" class="form-control" placeholder="0" required>
                                    </div>
									<div class="form-group">
