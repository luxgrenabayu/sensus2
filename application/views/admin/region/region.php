...
<body>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo site_url('region/create'); ?>" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span> Tambah Data</a>
                            </div> 
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#tampil_data").load('<?php echo base_url('region/view');?>');
        });
